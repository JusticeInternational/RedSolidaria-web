...
class VersionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post versions_url, params: { version: { created: @version.created, major: @version.major, minor: @version.minor, patch: @version.patch, value: @version.value } }
    end
  ...
  test "should update version" do
    patch version_url(@version), params: { version: { created: @version.created, major: @version.major, minor: @version.minor, patch: @version.patch, value: @version.value } }
